                    ...
                    <div className="flex justify-center">
                      ...
                      >
                        <div
                          ...
                          className={`h-[8px] w-full bg-linear-to-r ${roundBottomPrimary ? "rounded-br-full rounded-bl-full" : ""} ${roundTopPrimary ? "rounded-tl-full rounded-tr-full" : ""} ${severityColors[severityValue]}`}
                        ></div>
                      </div>
                    </div>
                  </div>
